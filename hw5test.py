...
# Auto Tester for Duke CS/ECE 250, Homework 5, Spring 2017

import sys,os,platform
from optparse import OptionParser

test_dir = 'tests'
suite_names = ['dir_map_wb', 'dir_map_wt', 'set_assoc_wb', 'set_assoc_wt']
suites = {
    "dir_map_wb": [
        { "desc": "Write-back and write-allocate direct mapped cache", "args": ['tracefile 2 1 wb 32'] },
    ],
    "dir_map_wt": [
        { "desc": "Write-through and write-no-allocate direct mapped cache", "args": ['tracefile 2 1 wt 32'] },
    ],
    "set_assoc_wb": [
        { "desc": "Write-back and write-allocate set-associative cache", "args": ['tracefile 4 4 wb 32'] },
    ],
    "set_assoc_wt": [
        { "desc": "Write-through and write-no-allocate set-associative cache", "args": ['tracefile 4 4 wt 32'] },
    ],
}
...
def run_test_suite(suite_name):
	...
	if not os.path.isfile(expected_output_filename):
        ...
        command = "timeout 10s %s %s > %s" % (executable, " ".join(args), actual_output_filename)
